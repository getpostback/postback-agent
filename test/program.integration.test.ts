...
describe('CLI command integration', () => {
  ...
  it.each([
    ...
    { args: ['analytics', 'content', 'app_123', '--days', '14', '--country', 'FR'], path: '/v1/agent/apps/app_123/analytics/content?days=14&country=FR' },
    { args: ['social', 'accounts', 'app_123'], path: '/v1/agent/apps/app_123/social/accounts' },
    { args: ['social', 'posts', 'app_123', '--days', '14', '--platform', 'tiktok'], path: '/v1/agent/apps/app_123/social/posts?days=14&platform=tiktok' },
